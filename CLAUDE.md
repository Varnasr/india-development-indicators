...
Eight World Bank indicators for India, fetched live. Single page, no build step, deployed on Netlify.
...
`const BASE = 'https://api.worldbank.org/v2/country/IND/indicator/'`, with eight series including NY.GDP.PCAP.CD, EG.ELC.ACCS.ZS and IT.NET.USER.ZS. Verified live on 2026-09-22.
